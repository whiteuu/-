...
def _read_images_and_labels(dir_name, flatten, ext='.jpg', **meta):
    images = []
    labels = []
...
if __name__ == '__main__':
    # import sys
    meta, train_data, test_data = load_data('H:/Users/ca/PycharmProjects/untitled/image')
    print(train_data.images.shape[0])
